        ...
        if ($x !== null && $y !== null && $w !== null && $h !== null) {
            ...
            if ($cornerTL || $cornerTR || $cornerBL || $cornerBR) {
                ...
                if ($cornerTR) {
                    ...
                    $yt2 = ($y2+$cornerTR[1])-$cornerTR[1]*self::MY_ARC;$path.= sprintf('%.2F %.2F l ', $x2-$cornerTR[0], $y2);
                ...
                if ($cornerBR) {
                    ...
                    $yt2 = ($y3-$cornerBR[1])+$cornerBR[1];$path.= sprintf('%.2F %.2F l ', $x3, $y3-$cornerBR[1]);
                ...
                if ($cornerBL) {
                    ...
                    $yt2 = ($y4-$cornerBL[1])+$cornerBL[1]*self::MY_ARC;$path.= sprintf('%.2F %.2F l ', $x4+$cornerBL[0], $y4);
                ...
                if ($cornerTL) {
                    ...
                    $yt2 = ($y1+$cornerTL[1])-$cornerTL[1];$path.= sprintf('%.2F %.2F l ', $x1, $y1+$cornerTL[1]);
        ...
        foreach ($actions as $action) {
            switch ($action[0]) {
                ...
                case 'A':
                    ...
                    $y1 = $last[1];     // begin y
                    $x2 = $action[6];   // final x
                    $y2 = $action[7];   // final y$this->_Arc2($x1, $y1, $x2, $y2, $rx, $ry, $a, $l, $s, true);
                    $x = $x2;
                    $y = $y2;
                    $xc = $x;
                    $yc = $y;
                ...
                case 'a':
                    ...
                    $y2 = $last[1]+$action[7]; // final y$this->_Arc2($x1, $y1, $x2, $y2, $rx, $ry, $a, $l, $s, true);
                    $x = $x2;
                    $y = $y2;
                    $xc = $x;
                    $yc = $y;
