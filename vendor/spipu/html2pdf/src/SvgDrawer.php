        ...
        for ($k=0; $k < $amountMatches; $k++) {
            ...
            switch ($name) {
                case 'scale':
                    ...
                    $values[1] = floatval($values[1]);$actions[] = array($values[0],0.,0.,$values[1],0.,0.);
                    break;
                ...
                case 'translate':
                    ...
                    $values[1] = $this->cssConverter->convertToMM($values[1], $this->getProperty('h'));$actions[] = array(1.,0.,0.,1.,$values[0],$values[1]);
                    break;
                ...
                case 'rotate':
                    ...
                    $values[2] = $this->cssConverter->convertToMM($values[2], $this->getProperty('h'));if ($values[1] || $values[2]) {
                        $actions[] = array(1.,0.,0.,1.,-$values[1],-$values[2]);
                    }$actions[] = array(cos($values[0]),sin($values[0]),-sin($values[0]),cos($values[0]),0.,0.);if ($values[1] || $values[2]) {
                        $actions[] = array(1.,0.,0.,1.,$values[1],$values[2]);
                    }
                    break;
                ...
                case 'skewx':
                    if (!array_key_exists(0, $values)) {
                        $values[0] = 0.;
                    }$values[0] = $values[0]*M_PI/180.;$actions[] = array(1.,0.,tan($values[0]),1.,0.,0.);
                    break;

                case 'skewy':
                    if (!array_key_exists(0, $values)) {
                        $values[0] = 0.;
                    }$values[0] = $values[0]*M_PI/180.;$actions[] = array(1.,tan($values[0]),0.,1.,0.,0.);
                    break;
                ...
                case 'matrix':
                    ...
                    $values[5] = $this->cssConverter->convertToMM($values[5], $this->getProperty('h'));$actions[] = $values;
                    break;
            }
        }
